...
class _$ItemImpl implements _Item {
  ...
  @override
  String toString() {
    return 'Item(id: $id, description: $description, unitPrice: $unitPrice, unit: $unit, taxRate: $taxRate, category: $category, isActive: $isActive)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, description, unitPrice, unit,
      taxRate, category, isActive);

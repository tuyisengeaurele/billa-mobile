...
class _$AuthUserImpl implements _AuthUser {
  ...
  @override
  String toString() {
    return 'AuthUser(id: $id, email: $email, name: $name, phone: $phone, avatarUrl: $avatarUrl, totpEnabled: $totpEnabled, isAdmin: $isAdmin)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, email, name, phone, avatarUrl, totpEnabled, isAdmin);
...
abstract class _AuthUser implements AuthUser {
  const factory _AuthUser(
      ...
      required final bool isAdmin}) = _$AuthUserImpl;

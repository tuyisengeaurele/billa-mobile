...
class _$AppNotificationImpl extends _AppNotification {
  const _$AppNotificationImpl(
      {required this.id,
      @JsonKey(fromJson: _typeFromJson, toJson: _typeToJson) this.type,
      required this.title,
      this.body,
      this.link,
      this.readAt,
  ...
  @override
  String toString() {
    return 'AppNotification(id: $id, type: $type, title: $title, body: $body, link: $link, readAt: $readAt, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, type, title, body, link, readAt, createdAt);
